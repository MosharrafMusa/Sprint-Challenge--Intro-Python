...
print("Starts with D:")
a = [human.name for human in humans if human.name.startswith(
    'd') or human.name.startswith('D')]
print(a)

# Write a list comprehension that creates a list of names of everyone
# whose name ends in "e".
print("Ends with e:")
b = [human.name for human in humans if human.name.endswith(
    'e') or human.name.endswith('E')]
print(b)
...
f = [(human.name, human.age)
     for human in humans if human.age <= 32 and human.age >= 27]
print(f)
